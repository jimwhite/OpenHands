...
class DSPyResponseParser(ResponseParser):
    """Parser action:
    ...
    def __init__(self):
        ...
        super().__init__()
        self.action_parsers = [
            DSPyActionParserFinish(),
            DSPyActionParserFileEdit(),
            DSPyActionParserCmdRun(),
            DSPyActionParserIPythonRunCell(),
            DSPyActionParserAgentDelegate(),
        ]
        self.default_parser = DSPyActionParserMessage()
...
class DSPyActionParserFinish(ActionParser):
    """Parser action:
    - AgentFinishAction() - end the interaction
    """
...
class DSPyActionParserCmdRun(ActionParser):
    """Parser action:
    - CmdRunAction(command) - bash command to run
    - AgentFinishAction() - end the interaction
    """
...
class DSPyActionParserIPythonRunCell(ActionParser):
    """Parser action:
    - IPythonRunCellAction(code) - IPython code to run
    """
...
class DSPyActionParserAgentDelegate(ActionParser):
    """Parser action:
    - AgentDelegateAction(agent, inputs) - delegate action for (sub)task
    """
...
class DSPyActionParserMessage(ActionParser):
    """Parser action:
    - MessageAction(content) - Message action to run (e.g. ask for clarification)
    """
...
class DSPyActionParserFileEdit(ActionParser):
    """Parser action:
    - FileEditAction(path, content) - edit a file
    """
